...
//	Chunk c0d01 =null;
	...
	public CreaCotizacion2(String cliente, String cantidadc[], String unidadc[], String[] preciouc, String descripcionc[], String contacto, String telefono, String email,
	...
	public static void main(String cliente, String  cantidadc[], String unidadc [], String preciouc[], String descripcionc[], String contacto, String telefono, String email, String lugar, String fecha, String diasc[], String descripcionev, String box[],String fechaso,String fechade,String horariode,String diasmo,String diasev, String clacificacion[], String  fecmonta,String horades,String horariose,String horariodesm, String horariomont, String cotizacion,String importec [], String[] descripcionc0, String[] descripcionc3,int agrega, String subtotalc,String grantotalc,String iva16c)  {
		...
		try{
			...
			CreaCotizacion2 ccn = new CreaCotizacion2(cliente, cantidadc, unidadc, preciouc, descripcionc, contacto, telefono, email,lugar,fecha,diasc,descripcionev,box,fechaso,fechade,horariode,diasmo,diasev,clacificacion,fecmonta,horades, horariose,horariodesm,horariomont,cotizacion,importec,descripcionc0,descripcionc3,agrega,subtotalc,grantotalc,iva16c);	
...
//
            ...
            Arial.setSize(10.0f);
 	        ...
 	        ColumnText.showTextAligned(canvas2, 0, phraset, 540.0f, 311.0f, 0.0f);
 	        System.out.println("Generando subtotal: " + phraset);
	 
 	        Arial.setSize(10.0f);
	        Arial.setStyle(0);
	        phraset = new Phrase(c0iva);	
	        ColumnText.showTextAligned(canvas2, 0, phraset, 540.0f, 288.0f, 0.0f);
	        System.out.println("Generando iva: " + phraset);
 	        
            Arial.setSize(10.0f);
  	        Arial.setStyle(0);
  	        phraset = new Phrase(c0gran);	
  	        ColumnText.showTextAligned(canvas2, 0, phraset, 540.0f, 266.0f, 0.0f);
  	 ...
  	 //// campos fijos
	        ...
	        ColumnText.showTextAligned(canvas, 0, phraset, 170.0f, 481.0f, 0.0f);
	       ...
	       ///////////// generando fila 2 f2
	        ...
	        if (agrega > 2 ) { 
		        ...
		        ColumnText.showTextAligned(canvas, 0, phraset, 170.0f, 397.0f, 0.0f);
		        System.out.println("Generando clacificacion renglon 2: " + phraset);
 ...
 ///////////// generando fila 6 f6
	        ...
	        if (agrega > 5 ) { 
		        ...
		        ColumnText.showTextAligned(canvas, 0, phraset, 170.0f, 271.0f, 0.0f);
...
///////////// generando fila 8 f8
	        ...
	        if (agrega > 7 ) { 
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 476.0f, 631.0f, 0.0f);
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 22.0f, 631.0f, 0.0f);
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 375.0f, 631.0f, 0.0f);
		        System.out.println("Generando precio unitario : renglon 8 " + phraset);
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0u7);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 72.0f, 631.0f, 0.0f);
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 170.0f, 650.0f, 0.0f);
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 640.0f, 0.0f);
...
///////////// generando fila 9 f9
	        ...
	        if (agrega > 8 ) { 
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 476.0f, 590.0f, 0.0f);
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 22.0f, 590.0f, 0.0f);
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 375.0f, 590.0f, 0.0f);
		        System.out.println("Generando precio unitario : renglon 9 " + phraset);
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0u8);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 72.0f, 590.0f, 0.0f);
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 170.0f, 607.0f, 0.0f);
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 598.0f, 0.0f);
...
///////////// generando fila 10 / Hoja 2 f10
	        ...
	        if (agrega > 9 ) { 
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 476.0f, 550.0f, 0.0f);
		        System.out.println("Generando dias de serv renglon 10: " + phraset);
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 22.0f, 550.0f, 0.0f);
		        System.out.println("Generando cantidad renglon 10 : " + phraset);
		 
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0pr9);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 375.0f, 550.0f, 0.0f);
		        System.out.println("Generando precio unitario : renglon 10" + phraset);
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0u9);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 72.0f, 550.0f, 0.0f);
		        System.out.println("Generando unidad renglon 10 : " + phraset);
		 

		        Arial.setSize(10.0f);
		        Arial.setStyle(1);
		        phraset = new Phrase(c0cla9);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 170.0f, 566.0f, 0.0f);
		        System.out.println("Generando clacificacion renglon 10: " + phraset);

		   
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d19);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 558.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 1 renglon 10: " + phraset);
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 548.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 2: renglon 10 " + phraset);
		        
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d39);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 538.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 3 :  renglon 10" + phraset);

		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0import9);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 550.0f, 551.0f, 0.0f);
		        System.out.println("Generando importe t : fila 10" + phraset);
...
///////////// generando fila 11 / Hoja 2 f11
	        ...
	        if (agrega > 10 ) { 
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 476.0f, 510.0f, 0.0f);
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 22.0f, 510.0f, 0.0f);
		        System.out.println("Generando cantidad renglon 11 : " + phraset);
		 
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0pr10);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 375.0f, 510.0f, 0.0f);
		        System.out.println("Generando precio unitario : renglon 11" + phraset);
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0u10);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 72.0f, 510.0f, 0.0f);
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 170.0f, 524.0f, 0.0f);
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 516.0f, 0.0f);
...
///////////// generando fila 12 / Hoja 2 f12
	        ...
	        if (agrega > 11 ) { 
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 476.0f, 469.0f, 0.0f);
		        System.out.println("Generando dias de serv renglon 11: " + phraset);
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 22.0f, 469.0f, 0.0f);
		        System.out.println("Generando cantidad renglon 11 : " + phraset);
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 375.0f, 469.0f, 0.0f);
		        System.out.println("Generando precio unitario : renglon 11" + phraset);
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0u11);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 72.0f, 469.0f, 0.0f);
		        System.out.println("Generando unidad renglon 11 : " + phraset);
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 170.0f, 482.0f, 0.0f);
		        System.out.println("Generando clacificacion renglon 11: " + phraset);
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 474.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 1 renglon 11: " + phraset);
		        ...
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 464.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 2: renglon 11 " + phraset);
		        
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d311);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 454.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 3 :  renglon 11" + phraset);

		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0import11);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 550.0f, 469.0f, 0.0f);
		        System.out.println("Generando importe t : fila 11" + phraset);
	        ...
	        if (agrega > 2 ) { 
		        ...
		        Arial.setStyle(1);
		        phraset = new Phrase(c0cla3);
		        ColumnText.showTextAligned(canvas, 0, phraset, 170.0f, 313.0f, 0.0f);
		        System.out.println("Generando clacificacion renglon 5: " + phraset);
	       ...
	       ///////////// generando fila 4 f4
	        ...
	        if (agrega > 3 ) { 
		        ...
		        Arial.setStyle(1);
		        phraset = new Phrase(c0cla3);
		        ColumnText.showTextAligned(canvas, 0, phraset, 170.0f, 229.0f, 0.0f);
		        System.out.println("Generando clacificacion renglon 7: " + phraset);
 ...
 ///////////// generando fila 5  f5
	        ...
	        if (agrega > 4 ) { 
		        ...
		        Arial.setStyle(1);
		        phraset = new Phrase(c0cla4);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 170.0f, 648.0f, 0.0f);
		        System.out.println("Generando clacificacion renglon 8: " + phraset);
...
////	        Arial.setSize(08.0f);
	        ...
	        ColumnText.showTextAligned(canvas2, 0, phraset, 85.0f, 72.0f, 0.0f);
