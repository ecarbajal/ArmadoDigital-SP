...
public class CreaCotizacion3 {

		
	public static final String plantilla2 = CtsArmado.pathJar + "Cotizacion2 SP 1.2.pdf";
...
//	Chunk c0d01 =null;
	...
	public CreaCotizacion3(String cliente, String cantidadc[], String unidadc[], String[] preciouc, String descripcionc[], String contacto, String telefono, String email,
			String lugar, String fecha, String[] diasc, String descripcionev, String box[],String fechaso,String fechade,String horariode,String diasmo,String diasev, String  clacificacion [], String  fecmonta,String horades,String horariose, String horariodesm, String horariomont, String cotizacion, String importec [], String[] descripcionc0, String[] descripcionc3, int agrega, String subtotalc, String grantotalc, String iva16c) {
	...
	public static void main(String cliente, String  cantidadc[], String unidadc [], String preciouc[], String descripcionc[], String contacto, String telefono, String email, String lugar, String fecha, String diasc[], String descripcionev, String box[],String fechaso,String fechade,String horariode,String diasmo,String diasev, String clacificacion[], String  fecmonta,String horades,String horariose,String horariodesm, String horariomont, String cotizacion,String importec [], String[] descripcionc0, String[] descripcionc3,int agrega, String subtotalc,String grantotalc,String iva16c)  {
		
		try{
			
			CreaCotizacion3 ccn = new CreaCotizacion3(cliente, cantidadc, unidadc, preciouc, descripcionc, contacto, telefono, email,lugar,fecha,diasc,descripcionev,box,fechaso,fechade,horariode,diasmo,diasev,clacificacion,fecmonta,horades, horariose,horariodesm,horariomont,cotizacion,importec,descripcionc0,descripcionc3,agrega,subtotalc,grantotalc,iva16c);	
	 ...
	 public void creaCotizaSP(String cliente, String[] cantidadc,  String unidadc[], String[] preciouc, String[] descripcionc, String contacto, String telefono, String email, String lugar, String fecha, String[] diasc, String descripcionev, String[] box,String fechaso,String fechade,String horariode,String diasmo,String diasev, String clacificacion [], String fecmonta, String horades, String horariose, String horariodesm, String horariomont, String cotizacion, String[] importec, String[] descripcionc0, String[] descripcionc3, int agrega, String subtotalc, String grantotalc, String iva16c) throws IOException, DocumentException {
		 ...
		 Calendar c = new GregorianCalendar();
	        ...
	        PdfReader reader = new PdfReader("C:\\Armado Digital SP\\Images\\Cotizacion2 SP 1.2.pdf");
...
//
            ...
            Arial.setSize(10.0f);
 	        ...
 	        ColumnText.showTextAligned(canvas2, 0, phraset, 550.0f, 196.0f, 0.0f);
 	        System.out.println("Generando subtotal: " + phraset);
	 
 	        Arial.setSize(10.0f);
	        Arial.setStyle(0);
	        phraset = new Phrase(c0iva);	
	        ColumnText.showTextAligned(canvas2, 0, phraset, 550.0f, 173.0f, 0.0f);
	        System.out.println("Generando iva: " + phraset);
 	        
            Arial.setSize(10.0f);
  	        Arial.setStyle(0);
  	        phraset = new Phrase(c0gran);	
  	        ColumnText.showTextAligned(canvas2, 0, phraset, 550.0f, 152.0f, 0.0f);
...
///////////// generando fila 7 
	        ...
	        if (agrega > 6 ) { 
	        	...
	        	Arial.setSize(10.0f);
		        Arial.setStyle(0);
				phraset = new Phrase(c0di6);
		        ColumnText.showTextAligned(canvas, 0, phraset, 476.0f, 216.0f, 0.0f);
		        System.out.println("Generando dias de serv renglon 7: " + phraset);
	        
		        

		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0ca6);
		        ColumnText.showTextAligned(canvas, 0, phraset, 22.0f, 216.0f, 0.0f);
		        System.out.println("Generando cantidad renglon 7 : " + phraset);
		 
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0pr6);
		        ColumnText.showTextAligned(canvas, 0, phraset, 375.0f, 216.0f, 0.0f);
		        System.out.println("Generando precio unitario : renglon 7 " + phraset);
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0u6);
		        ColumnText.showTextAligned(canvas, 0, phraset, 72.0f, 216.0f, 0.0f);
		        System.out.println("Generando unidad renglon 7 : " + phraset);
		 

		        Arial.setSize(11.0f);
		        Arial.setStyle(1);
		        phraset = new Phrase(c0cla6);
		        ColumnText.showTextAligned(canvas, 0, phraset, 170.0f, 230.0f, 0.0f);
		        System.out.println("Generando clacificacion renglon 7: " + phraset);

		   
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d16);
		        ColumnText.showTextAligned(canvas, 0, phraset, 120.0f, 221.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 1 renglon 7: " + phraset);
		        
		  

		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d26);
		        ColumnText.showTextAligned(canvas, 0, phraset, 120.0f, 211.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 2: renglon 7 " + phraset);
		        
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d36);
		        ColumnText.showTextAligned(canvas, 0, phraset, 120.0f, 201.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 3 :  renglon 7" + phraset);

		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0import6);
		        ColumnText.showTextAligned(canvas, 0, phraset, 550.0f, 216.0f, 0.0f);
		        System.out.println("Generando importe t : fila 7" + phraset);
...
///////////// generando fila 8 f8
	        ...
	        if (agrega > 7 ) { 
	        	...
	        	Arial.setSize(10.0f);
		        Arial.setStyle(0);
				phraset = new Phrase(c0di7);
		        ColumnText.showTextAligned(canvas, 0, phraset, 476.0f, 466.0f, 0.0f);
		        System.out.println("Generando dias de serv renglon 8: " + phraset);
	        
		        

		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0ca7);
		        ColumnText.showTextAligned(canvas, 0, phraset, 22.0f, 466.0f, 0.0f);
		        System.out.println("Generando cantidad renglon 8 : " + phraset);
		 
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0pr7);
		        ColumnText.showTextAligned(canvas, 0, phraset, 375.0f, 466.0f, 0.0f);
		        System.out.println("Generando precio unitario : renglon 8 " + phraset);
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0u7);
		        ColumnText.showTextAligned(canvas, 0, phraset, 72.0f, 466.0f, 0.0f);
		        System.out.println("Generando unidad renglon 8 : " + phraset);
		 

		        Arial.setSize(11.0f);
		        Arial.setStyle(1);
		        phraset = new Phrase(c0cla7);
		        ColumnText.showTextAligned(canvas, 0, phraset, 170.0f, 480.0f, 0.0f);
		        System.out.println("Generando clacificacion renglon 8: " + phraset);

		   
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d17);
		        ColumnText.showTextAligned(canvas, 0, phraset, 120.0f, 471.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 1 renglon 8: " + phraset);
		        
		  

		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d27);
		        ColumnText.showTextAligned(canvas, 0, phraset, 120.0f, 461.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 2: renglon 8 " + phraset);
		        
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d37);
		        ColumnText.showTextAligned(canvas, 0, phraset, 120.0f, 451.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 3 :  renglon 8" + phraset);

		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0import7);
		        ColumnText.showTextAligned(canvas, 0, phraset, 550.0f, 466.0f, 0.0f);
		        System.out.println("Generando importe t : fila 8" + phraset);
...
///////////// generando fila 9 f9
	        ...
	        if (agrega > 8 ) { 
	        	...
	        	Arial.setSize(10.0f);
		        Arial.setStyle(0);
				phraset = new Phrase(c0di8);
		        ColumnText.showTextAligned(canvas, 0, phraset, 476.0f, 426.0f, 0.0f);
		        System.out.println("Generando dias de serv renglon 9: " + phraset);
	        
		        

		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0ca8);
		        ColumnText.showTextAligned(canvas, 0, phraset, 22.0f, 426.0f, 0.0f);
		        System.out.println("Generando cantidad renglon 9 : " + phraset);
		 
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0pr8);
		        ColumnText.showTextAligned(canvas, 0, phraset, 375.0f, 426.0f, 0.0f);
		        System.out.println("Generando precio unitario : renglon 9 " + phraset);
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0u8);
		        ColumnText.showTextAligned(canvas, 0, phraset, 72.0f, 426.0f, 0.0f);
		        System.out.println("Generando unidad renglon 9 : " + phraset);
		 

		        Arial.setSize(11.0f);
		        Arial.setStyle(1);
		        phraset = new Phrase(c0cla8);
		        ColumnText.showTextAligned(canvas, 0, phraset, 170.0f, 440.0f, 0.0f);
		        System.out.println("Generando clacificacion renglon 9: " + phraset);

		   
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d18);
		        ColumnText.showTextAligned(canvas, 0, phraset, 120.0f, 430.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 1 renglon 9: " + phraset);
		        
		  

		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d28);
		        ColumnText.showTextAligned(canvas, 0, phraset, 120.0f, 420.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 2: renglon 9 " + phraset);
		        
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d38);
		        ColumnText.showTextAligned(canvas, 0, phraset, 120.0f, 410.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 3 :  renglon 9" + phraset);

		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0import8);
		        ColumnText.showTextAligned(canvas, 0, phraset, 550.0f, 426.0f, 0.0f);
		        System.out.println("Generando importe t : fila 9" + phraset);
...
///////////// generando fila 10 / Hoja 2 f10
	        ...
	        if (agrega > 9 ) { 
		        ...
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0ca9);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 22.0f, 466.0f, 0.0f);
		        System.out.println("Generando cantidad :  9 " + phraset);
		 
		        
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0u9);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 72.0f, 466.0f, 0.0f);
		        System.out.println("Generando unidad :  9 " + phraset);
		 

		        Arial.setSize(11.0f);
		        Arial.setStyle(1);
		        phraset = new Phrase(c0cla9);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 170.0f, 480.0f, 0.0f);
		        System.out.println("Generando clacificacion :  9" + phraset);

		   
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d19);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 471.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 1 : 9 " + phraset);
		        
		  

		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d29);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 461.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 2:  9" + phraset);
		        
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d39);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 451.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 3 9 : " + phraset);
		        ...
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0pr9);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 375.0f, 466.0f, 0.0f);
		        System.out.println("Generando precio unitario 9: " + phraset);
		       
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0di9);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 476.0f, 466.0f, 0.0f);
		        System.out.println("Generando dias de serv renglon 9: " + phraset);
		        ...
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0import9);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 550.0f, 466.0f, 0.0f);
		        System.out.println("Generando importe 9: " + phraset);
...
///////////// generando fila 11 / Hoja 2 f11
	        ...
	        if (agrega > 10 ) { 
	        	...
	        	Arial.setSize(10.0f);
		        Arial.setStyle(0);
				phraset = new Phrase(c0di10);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 476.0f, 426.0f, 0.0f);
		        System.out.println("Generando dias de serv renglon 11: " + phraset);
	        
		        

		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0ca10);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 22.0f, 426.0f, 0.0f);
		        System.out.println("Generando cantidad renglon 211 : " + phraset);
		 
		        
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0u10);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 72.0f, 426.0f, 0.0f);
		        System.out.println("Generando unidad renglon 11 : " + phraset);
		 

		        Arial.setSize(11.0f);
		        Arial.setStyle(1);
		        phraset = new Phrase(c0cla10);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 170.0f, 440.0f, 0.0f);
		        System.out.println("Generando clacificacion renglon 11: " + phraset);

		   
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d110);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 430.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 1 renglon 11: " + phraset);
		        
		  

		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d210);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 420.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 2: renglon 11 " + phraset);
		        
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d310);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 410.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 3 :  renglon 11" + phraset);
		        ...
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0pr10);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 375.0f, 426.0f, 0.0f);
		        System.out.println("Generando precio unitario : renglon 11 " + phraset);
		        

		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0import10);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 550.0f, 426.0f, 0.0f);
		        System.out.println("Generando importe t : fila 11" + phraset);
		       
		       
		       
	 }
	       
///////////// generando fila 12 / Hoja 2 f12
	        ...
	        if (agrega > 11 ) { 
	        	...
	        	Arial.setSize(10.0f);
		        Arial.setStyle(0);
				phraset = new Phrase(c0di11);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 476.0f, 383.0f, 0.0f);
		        System.out.println("Generando dias de serv renglon 2: 12" + phraset);
	        
		        

		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0ca11);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 22.0f, 383.0f, 0.0f);
		        System.out.println("Generando cantidad renglon 2 : 12" + phraset);
		 
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0pr11);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 375.0f, 383.0f, 0.0f);
		        System.out.println("Generando precio unitario : renglon 212 " + phraset);
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0u11);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 72.0f, 383.0f, 0.0f);
		        System.out.println("Generando unidad renglon 2 : 12" + phraset);
		 

		        Arial.setSize(11.0f);
		        Arial.setStyle(1);
		        phraset = new Phrase(c0cla11);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 170.0f, 396.0f, 0.0f);
		        System.out.println("Generando clacificacion renglon 2: 12" + phraset);

		   
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d111);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 387.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 1 renglon 2:12 " + phraset);
		        
		  

		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d211);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 377.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 2: renglon 2 12" + phraset);
		        
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d311);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 367.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 3 :  renglon 212" + phraset);

		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0import11);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 550.0f, 383.0f, 0.0f);
		        System.out.println("Generando importe t : fila 3 12" + phraset);
		       
		       
	 }
	        
		       
///////////// generando fila 13 / Hoja 2 f13
	        ...
	        if (agrega > 12 ) { 
	        	...
	        	Arial.setSize(10.0f);
		        Arial.setStyle(0);
				phraset = new Phrase(c0di12);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 476.0f, 341.0f, 0.0f);
		        System.out.println("Generando dias de serv renglon 2: 13" + phraset);
	        
		        

		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0ca12);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 22.0f, 341.0f, 0.0f);
		        System.out.println("Generando cantidad renglon 2 : 13" + phraset);
		 
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0pr12);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 375.0f, 341.0f, 0.0f);
		        System.out.println("Generando precio unitario : renglon 2 13" + phraset);
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0u12);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 72.0f, 341.0f, 0.0f);
		        System.out.println("Generando unidad renglon 2 : 13" + phraset);
		 

		        Arial.setSize(11.0f);
		        Arial.setStyle(1);
		        phraset = new Phrase(c0cla12);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 170.0f, 355.0f, 0.0f);
		        System.out.println("Generando clacificacion renglon 2: 13" + phraset);

		   
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d112);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 346.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 1 renglon 2: 13" + phraset);
		        
		  

		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d212);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 336.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 2: renglon 2 13" + phraset);
		        
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d312);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 326.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 3 :  renglon 213" + phraset);
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0import12);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 550.0f, 341.0f, 0.0f);
		        System.out.println("Generando importe t : fila 413" + phraset);
...
///////////// generando fila 14 / Hoja 2 f14
	        ...
	        if (agrega > 13 ) { 
	        	...
	        	Arial.setSize(10.0f);
		        Arial.setStyle(0);
				phraset = new Phrase(c0di14);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 476.0f, 300.0f, 0.0f);
		        System.out.println("Generando dias de serv renglon 5: 14" + phraset);
	        
		        

		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0ca14);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 22.0f, 300.0f, 0.0f);
		        System.out.println("Generando cantidad renglon 5 : 14" + phraset);
		 
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0pr14);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 375.0f, 300.0f, 0.0f);
		        System.out.println("Generando precio unitario : renglon 5 14" + phraset);
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0u14);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 72.0f, 300.0f, 0.0f);
		        System.out.println("Generando unidad renglon 5 : 14" + phraset);
		 

		        Arial.setSize(11.0f);
		        Arial.setStyle(1);
		        phraset = new Phrase(c0cla14);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 170.0f, 314.0f, 0.0f);
		        System.out.println("Generando clacificacion renglon 5: 14" + phraset);

		   
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d114);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 305.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 1 renglon 5: 14" + phraset);
		        
		  

		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d214);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 295.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 2: renglon 5 14" + phraset);
		        
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d314);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 285.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 3 :  renglon 5 14" + phraset);
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0import14);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 550.0f, 300.0f, 0.0f);
		        System.out.println("Generando importe t : fila 5 14" + phraset);
...
///////////// generando fila 15 / Hoja 2 f15
	        ...
	        if (agrega > 14 ) { 
	        	...
	        	Arial.setSize(10.0f);
		        Arial.setStyle(0);
				phraset = new Phrase(c0di15);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 476.0f, 258.0f, 0.0f);
		        System.out.println("Generando dias de serv renglon 6: 15" + phraset);
	        
		        

		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0ca15);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 22.0f, 258.0f, 0.0f);
		        System.out.println("Generando cantidad renglon 6 : 15" + phraset);
		 
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0pr15);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 375.0f, 258.0f, 0.0f);
		        System.out.println("Generando precio unitario : renglon 6 " + phraset);
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0u15);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 72.0f, 258.0f, 0.0f);
		        System.out.println("Generando unidad renglon 6 : 15" + phraset);
		 

		        Arial.setSize(11.0f);
		        Arial.setStyle(1);
		        phraset = new Phrase(c0cla15);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 170.0f, 272.0f, 0.0f);
		        System.out.println("Generando clacificacion renglon 6: 15" + phraset);

		   
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d115);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 263.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 1 renglon 6: 15" + phraset);
		        
		  

		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d215);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 253.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 2: renglon 615 " + phraset);
		        
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d315);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 243.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 3 :  renglon 615" + phraset);

		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0import15);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 550.0f, 258.0f, 0.0f);
		        System.out.println("Generando importe t : fila 6 15" + phraset);
...
///////////// generando fila 16 / Hoja 2 f16
	        ...
	        if (agrega > 15 ) { 
	          	...
	          	Arial.setSize(10.0f);
		        Arial.setStyle(0);
				phraset = new Phrase(c0di16);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 476.0f, 216.0f, 0.0f);
		        System.out.println("Generando dias de serv renglon 7: 16" + phraset);
	        
		        

		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0ca16);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 22.0f, 216.0f, 0.0f);
		        System.out.println("Generando cantidad renglon 7 : 16" + phraset);
		 
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0pr16);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 375.0f, 216.0f, 0.0f);
		        System.out.println("Generando precio unitario : renglon 7 16" + phraset);
		        
		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0u16);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 72.0f, 216.0f, 0.0f);
		        System.out.println("Generando unidad renglon 7 : 16" + phraset);
		 

		        Arial.setSize(11.0f);
		        Arial.setStyle(1);
		        phraset = new Phrase(c0cla16);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 170.0f, 230.0f, 0.0f);
		        System.out.println("Generando clacificacion renglon 7: 16" + phraset);

		   
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d116);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 221.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 1 renglon 7: 16" + phraset);
		        
		  

		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d216);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 211.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 2: renglon 7 16" + phraset);
		        
		        Arial.setSize(09.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0d316);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 120.0f, 201.0f, 0.0f);
		        System.out.println("Generando descripcion de producto 3 :  renglon 716" + phraset);

		        Arial.setSize(10.0f);
		        Arial.setStyle(0);
		        phraset = new Phrase(c0import16);
		        ColumnText.showTextAligned(canvas2, 0, phraset, 550.0f, 216.0f, 0.0f);
		        System.out.println("Generando importe t : fila 716" + phraset);
